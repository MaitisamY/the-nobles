                ...
                <div class="col-xl-5">
                    <div class="ms-tm-img-wrap ms-tm-space p-relative mb-60">
                        <div class="ms-tm-img-main p-relative m-img">
                            ...
                            <img src="assets/img/stock-pics/crowd3.jpg" alt="testimonial image">
                        </div>
                        <div class="ms-tm-img1 p-absolute w-img">
                            <img src="assets/img/stock-pics/crowd4.jpg" alt="testimonial image">
                        </div>
                        <div class="ms-tm-img2 p-absolute w-img">
                            <img src="assets/img/stock-pics/crowd6.jpg" alt="testimonial image">
                        </div>
                        <div class="ms-tm-img3 p-absolute w-img d-none d-sm-block">
                            <img src="assets/img/stock-pics/crowd7.jpg" alt="testimonial image">
                        </div>
                        <div class="ms-tm-img4 p-absolute w-img">
                            <img src="assets/img/stock-pics/crowd8.jpg" alt="testimonial image">
                        </div>
                        <div class="ms-tm-img5 p-absolute w-img">
                            <img src="assets/img/stock-pics/crowd9.jpg" alt="testimonial image">
                        </div>
                    </div>
                </div>
                <div class="col-xl-7">
